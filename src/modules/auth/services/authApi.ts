...
export const authApi = {
  ...
  verifyActivateAccountOtp: async (
  ...
  resendActivateAccountOtp: async (
  ...
  ): Promise<ForgotPasswordRequestResponseDTO> => {
    const formData = new FormData();
    formData.append('phone_number', data.phone_number);
    formData.append('expected_role', data.expected_role);
  ...
  forgotPasswordVerifyOtp: async (
    data: ForgotPasswordVerifyOtpRequestDTO,
  ): Promise<ForgotPasswordVerifyOtpResponseDTO> => {
